...
export const mockClinics: WizardClinic[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1571772996211-2f02c9727c7c?w=300&h=200&fit=crop",
  },
  {
    id: "clinic3",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1594736797933-d0f5e3c45fae?w=300&h=200&fit=crop",
  },
];
...
export const mockDoctors: WizardDoctor[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    avatar:
      "https://images.unsplash.com/photo-1594824019292-60f647afd842?w=150&h=150&fit=crop&crop=face",
...
export const mockSedationists: WizardSedationist[] = [
    ...
    certifications: [
      {
        ...
        issuingBody: "American Dental Association",
        certificateNumber: "ADA321",
        issueDate: "2021-01-01",
        expiryDate: "2024-01-01",
        status: CertificationStatus.VALID,
      },
      ...
      {
        id: "8",
        name: "Sedation Permit",
        issuingBody: "State Medical Board",
        certificateNumber: "SMB222",
        issueDate: "2020-01-01",
        expiryDate: "2025-01-01",
        status: CertificationStatus.VALID,
      },
  ...
  },
  {
    ...
    certifications: [
      ...
      {
        id: "10",
        name: "Pain Medicine Fellowship",
        issuingBody: "American Board of Anesthesiology",
        certificateNumber: "ABA777",
        issueDate: "2019-01-01",
        expiryDate: "2024-01-01",
        status: CertificationStatus.VALID,
      },
...
export const searchSedationists = (
  query: string,
  page: number = 1,
  pageSize: number = 10
) => {
  const filtered = mockSedationists.filter(
    (sedationist) =>
      `${sedationist.firstName} ${sedationist.lastName}`
        .toLowerCase()
        .includes(query.toLowerCase()) ||
      sedationist.specialties.some((specialty) =>
        specialty.toLowerCase().includes(query.toLowerCase())
      ) ||
      sedationist.certifications.some((cert) =>
