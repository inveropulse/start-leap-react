...
import {
  isAvailabilityInTimeSlot,
  isAvailabilityStartInSlot,
  isAvailabilityContinuation,
  calculateAvailabilityHeight,
} from "../utils/availabilityUtils";
import {
  isAppointmentInTimeSlot,
  isAppointmentStartInSlot,
  isAppointmentContinuation,
  formatPatientName,
...
export function TimeSlotGrid({ date }: TimeSlotGridProps) {
  ...
  const selectedSedationistsList =
    sedationists?.filter((s) => selectedSedationistIds.includes(s.id!)) || [];
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              ...
              <div
                ...
                style={{
                  minWidth: `${selectedSedationistsList.length * 200}px`,
                }}
              >
                {selectedSedationistsList.map((sedationist) => (
                  <div
                    key={sedationist.id}
                    className="flex-shrink-0 w-[200px] text-center"
                  >
                  ...
                  >
                    {selectedSedationistsList.map((sedationist) => {
                        ...
                        appointments?.filter(
                          (apt) =>
                            ...
                            isAppointmentInTimeSlot(
                              apt,
                              slot.time,
                              APP_CONFIG.calendar.timeSlotDuration || 60
                            )
                        ) || [];

                      // Find availabilities for this sedationist in this time slot
                      const sedationistAvailabilities =
                      ...
                      const startingAppointments =
                        sedationistAppointments.filter((apt) =>
                          isAppointmentStartInSlot(
                            apt,
                            slot.time,
                            APP_CONFIG.calendar.timeSlotDuration || 60
                      ...
                      const continuationAppointments =
                        sedationistAppointments.filter((apt) =>
                          isAppointmentContinuation(
                            apt,
                            slot.time,
                      ...
                      const startingAvailabilities =
                        sedationistAvailabilities.filter((avail) =>
                          isAvailabilityStartInSlot(
                            avail,
                            slot.time,
                            APP_CONFIG.calendar.timeSlotDuration || 60
                      ...
                      const continuationAvailabilities =
                        sedationistAvailabilities.filter((avail) =>
                          isAvailabilityContinuation(
                            avail,
                            slot.time,
                      ...
                      const hasContent =
                        ...
                        startingAvailabilities.length > 0 ||
                        continuationAvailabilities.length > 0;

                      const slotHeightPx = 60;
                      const slotDurationMinutes =
                        APP_CONFIG.calendar.timeSlotDuration || 30;
                      ...
                      return (
                        ...
                        >
                          ...
                          {startingAvailabilities.map((availability) => {
                            const height = calculateAvailabilityHeight(
                              availability,
                              slotHeightPx,
                              slotDurationMinutes
                            );
                            return (
                              <AvailabilityCard
                                ...
                                fullHeight={height}
                                onClick={() =>
                                  openAvailabilityModal(availability.id!)
                                }
                              />
                            );
                          })}
                          ...
                          {(continuationAppointments.length > 0 ||
                            ...
                            startingAvailabilities.length === 0 && (
                              <div className="space-y-1 p-1 w-full">
                                ...
                                {continuationAvailabilities.map(
                                  (availability) => (
                                    <div
