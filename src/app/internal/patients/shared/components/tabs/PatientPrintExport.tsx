...
export function PatientPrintExport({
      ...
      <html>
        ...
        <body>
          <div class="header">
            ...
            <h2>${patient.title ? `${patient.title} ` : ""}${
      patient.fullName || `${patient.firstName} ${patient.lastName}`
    }</h2>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              ...
              <div class="info-item"><span class="label">Sex:</span><span class="value">${
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div class="info-item"><span class="label">Primary Phone:</span><span class="value">${
              ...
              <div class="info-item"><span class="label">Town/City:</span><span class="value">${
                patient.town || "Not provided"
              }, ${patient.country || ""}</span></div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="info-item">
              ...
              <div class="value">ASA ${
                patient.asaClassification || "Not specified"
              }</div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div class="info-item"><span class="label">Height:</span><span class="value">${
                patient.height
                  ? `${patient.height} ${patient.heightFormat || "cm"}`
                  : "Not specified"
              }</span></div>
              <div class="info-item"><span class="label">Weight:</span><span class="value">${
                patient.weight
                  ? `${patient.weight} ${patient.weightFormat || "kg"}`
                  : "Not specified"
              }</span></div>
              <div class="info-item"><span class="label">BMI:</span><span class="value">${
                patient.bmi ? patient.bmi.toFixed(1) : "Not calculated"
              }</span></div>
              <div class="info-item"><span class="label">Smoking Status:</span><span class="value">${
          ...
          <div class="section">
            ...
            <div class="info-item"><span class="label">Patient ID:</span><span class="value">${
              patient.id
            }</span></div>
            <div class="info-item"><span class="label">Created:</span><span class="value">${formatDate(
              patient.createdDateTime
            )}</span></div>
            ${
              patient.ticketId
                ? `<div class="info-item"><span class="label">Ticket ID:</span><span class="value">${patient.ticketId}</span></div>`
                : ""
            }
          </div>
        </body>
  ...
  const handleExport = (format: "pdf" | "csv") => {
    ...
    if (format === "csv") {
      ...
      link.setAttribute(
        "download",
        `patient_${patient.id}_${new Date().toISOString().split("T")[0]}.csv`
      );
      ...
      alert(
        'PDF export: Please use your browser\'s print function and select "Save as PDF"'
      );
      handlePrint();
    }
  };
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="text-sm text-muted-foreground space-y-1">
          <p>
            <strong>Print:</strong> Generate a formatted summary for physical
            records
          </p>
          <p>
            <strong>PDF:</strong> Export as portable document for digital
            storage
          </p>
          <p>
            <strong>CSV:</strong> Export data for spreadsheet analysis
          </p>
          <p>
            <strong>Email:</strong> Send patient summary to authorized
            recipients
          </p>
        </div>
      </CardContent>
