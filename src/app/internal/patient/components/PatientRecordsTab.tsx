import { FileText, Upload, Search, Filter, Download, Eye, Trash2, Calendar, User } from "lucide-react";
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    {record.isLegacy && (
                      <div className="bg-orange-50 border border-orange-200 rounded p-2 text-sm">
                        <strong>Legacy Record:</strong> This record couldn't be linked to a specific appointment entity and was migrated from the previous system.
                      </div>
                    )}
                  </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {['Medical', 'Radiology', 'Laboratory', 'Legacy', 'Migrated'].map(category => {
              const count = records?.filter(r => r.category.toLowerCase() === category.toLowerCase()).length || 0;
              return (
